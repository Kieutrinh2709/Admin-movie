...
export default function Films() {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (text, film) => {
                return <Fragment>
                    <NavLink key={1} className=" mr-2  text-base" to={`/admin/films/edit/${film.maPhim}`}><EditOutlined style={{ color: 'blue' }} /> </NavLink>
                    ...
                    <NavLink key={3} className=" mr-2 text-base" to={`/admin/films/showtime/${film.maPhim}/${film.tenPhim}`} onClick={()=>{
